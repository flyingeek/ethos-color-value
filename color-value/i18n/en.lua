...
return {
    widgetNameTypeSourceASCII="Color Value", --ASCII
    widgetNameTypeSourceUTF8="Color Value",-- subset utf8
    widgetNameTypeSensorASCII="Color Telemetry", --ASCII
    widgetNameTypeSensorUTF8="Color Telemetry",-- subset utf8
    source="Source",
    case="Case%d",
    confirmTitle="Confirm",
    caseDeleteMessage="Delete Case%d ?",
    conditionLabel="If %s",
    help="Help",
    ok="OK",
    yes="Yes",
    no="No",
    logicPanel="Color to use (optional)",
    showTitle="Title",
    showMinMax="Minimum and Maximum",
    editMenuASCII="Edit %s", --ASCII
    editMenuUTF8="Edit %s",-- subset utf8
    ...
    infoPanelTitle="Widget informations",
